...
yay -S --noconfirm hyprland waybar alacritty rofi zsh neofetch \
    ...
    adwaita-qt6 adwaita-qt5 qt5ct qt6ct
...
# --- Configure Hyprland Session for SDDM ---
echo "[INFO] Configuring Hyprland session for SDDM..."
...
# --- Fix Hyprland Systemd Service ---
echo "[INFO] Fixing Hyprland systemd service..."
sudo tee /usr/lib/systemd/user/hyprland-session.service > /dev/null <<EOF
[Unit]
...
# Configure Qt Theme for Qt5 and Qt6
