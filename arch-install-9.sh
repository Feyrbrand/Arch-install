...
# Step 4: Install Base System (Including git and networkmanager)
...
pacman -S --noconfirm bluez bluez-utils pipewire pipewire-pulse pipewire-alsa wireplumber wl-clipboard swaybg \
    mesa vulkan-radeon brightnessctl power-profiles-daemon tlp ufw cups hplip system-config-printer \
    cpupower greetd wayland xdg-desktop-portal-wlr xorg-xwayland gvfs libgtop btop dart-sass swww python \
